...
public class GiocoTest {
	...
	public void testAttacco() {
		...
		/*
		 * L'attacco somma la potenza di fuoco degli invasori e distrugge il
		 * porto secondo questa equazione: metri_quadri_distrutti_del_porto =
		 * potenza_di_fuoco_invasori * 2.5
		 */
